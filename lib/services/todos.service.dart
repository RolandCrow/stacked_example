...
import 'package:stacked_example/models/todo.dart';


class TodosService with ReactiveServiceMixin { // сервис в стакед как модель в классе реактивный так как имеем дело с hive
